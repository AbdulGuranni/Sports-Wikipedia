...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" href="index.php"><img src="img/background/logo.jpg" 
...
<small id="emailHelp" class="muted" >Note: you will get updates related to the preferences selected</small>
      ...
      <div>
      <button type="submit" class="btn btn-primary">SignUp</button> <p>Already Have An Account ? <a href="login.php">LogIn</a></p></div>
            </div>
      </form>
    </main><!-- /.container -->
