...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="carousel-inner">
   <div class="carousel-item">
      <img class="d-block " src="img/cricket/dhoni.jpg" alt="MS Dhoni">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=2&teamID=21&name=MS"><div class="text">MS Dhoni</div></a>
        </div>
    </div>
    <div class="carousel-item">
